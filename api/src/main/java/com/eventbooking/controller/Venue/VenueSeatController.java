...
public class VenueSeatController {
    ...
    public VenueSeatController(VenueSeatService venueSeatService, OrganizerResolver organizerResolver) {
    ...
    public ResponseEntity<VenueSeatMapResponse> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(venueSeatService.createVenueSeats(organizerId, venueId, request));
    }
