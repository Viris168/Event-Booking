 ...
 *
 * @param botToken from @BotFather, "12345:AA...". A credential - anyone holding
 *                 it can post as the bot, so it belongs in .env, never in yml.
 * @param chatId   where to post. A personal chat is a positive number; a group
 *                 or channel is negative, usually -100-prefixed.
