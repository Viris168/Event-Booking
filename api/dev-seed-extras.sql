...
INSERT INTO notification (recipient_user_id, type, params, link_url, dedupe_key, read_at, created_at) VALUES
    -- Customers
    (5, 'BOOKING_CONFIRMED',
     '{"bookingRef":"KH-7QF2M8ZP","titleEn":"Bassac Riverside Live","titleKm":"បាសាក់រីវឺសាយ ឡាយ"}'::jsonb,
     '/bookings/1', 'booking:1:CONFIRMED', NULL, '2026-09-13 09:00:12+00'),
    (7, 'BOOKING_CONFIRMED',
     '{"bookingRef":"KH-5RT8WQ2N","titleEn":"Bassac Riverside Live","titleKm":"បាសាក់រីវឺសាយ ឡាយ"}'::jsonb,
     '/bookings/3', 'booking:3:CONFIRMED', '2026-09-09 08:00:00+00', '2026-09-09 07:04:02+00'),
    (8, 'BOOKING_CONFIRMED',
     '{"bookingRef":"KH-9BN4LC6V","titleEn":"Sbek Thom Shadow Play","titleKm":"ស្បែកធំ"}'::jsonb,
     '/bookings/4', 'booking:4:CONFIRMED', NULL, '2026-09-02 03:16:40+00'),
    (9, 'BOOKING_EXPIRED',
     '{"bookingRef":"KH-2XG7HP3K","titleEn":"Mekong DevFest 2026","titleKm":"មេគង្គ ដេវហ្វេស្ត ២០២៦"}'::jsonb,
     '/bookings/5', 'booking:5:EXPIRED', NULL, '2026-09-11 14:01:00+00'),
    (8, 'BOOKING_PAYMENT_FAILED',
     '{"bookingRef":"KH-4KQ2VS9J","titleEn":"PP Esports Finals","titleKm":"ភ្នំពេញ អ៊ីស្ព័រ ហ្វាយណល"}'::jsonb,
