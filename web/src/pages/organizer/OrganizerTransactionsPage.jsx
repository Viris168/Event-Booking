...
export default function OrganizerTransactionsPage() {
  ...
  const visible = useMemo(() => {
    ...
    const list = !needle
      ? rows
      : rows.filter((r) =>
          [r.booking_ref, r.buyer_name, r.buyer_phone_e164].some((v) =>
        ...
        <div className="px-5 py-3 border-b border-line-2 bg-surface-2 flex items-center gap-3 flex-wrap">
          <div className="relative">
            ...
            <input
              ...
              placeholder={
                km ? "ស្វែងរកប្រតិបត្តិការ…" : "Search transactions…"
              }
          ...
          >
            ...
            <option value="highest">
              {km ? "ទឹកប្រាក់ច្រើន" : "Highest amount"}
            </option>
            <option value="lowest">
          ...
          >
            ...
            {filtered &&
              ` · ${[q, state, eventId, provider].filter(Boolean).length}`}
          </button>
                    ...
                    >
                      <td>
                        <Link
                          ...
                          to={`/organizer/events/${r.event_id}/sales`}
                        >
                      ...
                      <td>
                        {r.payment_provider ? (
                          ...
                          <span className="badge badge-mode">
                            {PROVIDER_LABEL[r.payment_provider] ??
                              r.payment_provider}
                          </span>
                        ) : (
