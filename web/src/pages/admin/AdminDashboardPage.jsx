...
import { Alert, Badge, Empty, ResponsiveTable, Stat } from '../../components/ui.jsx'
...
const EMPTY_STATS = {
  ...
  gross_usd_cents: 0, gross_30d_usd_cents: 0, tickets_issued: 0, checked_in: 0,
  stuck_payments: 0, pending_applications: 0,
  on_sale_now: 0, payouts_to_send: 0, payouts_to_send_usd_cents: 0,
}
      ...
      <div className="panel">
        ...
        {recent.length === 0 && !loadError ? (
          <div className="panel-body">
            <Empty icon="calendar" title={km ? 'មិនទាន់មានព្រឹត្តិការណ៍ទេ' : 'No events yet'}>
              {km
